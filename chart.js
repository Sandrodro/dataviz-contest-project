const questions = [
  {
    ...
    text: [
      ...
      "მართალი ხარ! 2017 წელს საქართველოს ლეიბორისტული პარტია, 215 480 ლარის ოდენობის მივლინებების ხარჯით, პირველ ადგილზე გავიდა. მათი ხარჯები ყველა პარტიის ერთად აღებული ხარჯის მეოთხედზე მეტს შეადგენდა. მათ მოსდევთ პარტია “მრეწველობა გადაარჩენს საქართველოს”, რომელმაც 2017 წელს მივლინებებზე 128 869 ლარი დახარჯა. ქართული ოცნება - დემოკრატიული საქართველოს ანალოგიური ხარჯები 31 391 ლარს შეადგენდა. მეტი ინფორმაციისთვის მიყევი ამ <a href='https://askgov.ge/en/request/partiebis_shemosavlebis_statisti#incoming-73' target=_blank>ბმულს</a>",
      "ცდები! 2017 წელს საქართველოს ლეიბორისტული პარტია, 215 480 ლარის ოდენობის მივლინებების ხარჯით, პირველ ადგილზე გავიდა. მათი ხარჯები ყველა პარტიის ერთად აღებული ხარჯის მეოთხედზე მეტს შეადგენდა. მათ მოსდევთ პარტია “მრეწველობა გადაარჩენს საქართველოს”, რომელმაც 2017 წელს 128 869 ლარი დახარჯა. ქართული ოცნება - დემოკრატიული საქართველოს ანალოგიური ხარჯები 31 391 ლარს შეადგენდა. მეტი ინფორმაციისთვის მიყევი ამ <a href='https://askgov.ge/en/request/partiebis_shemosavlebis_statisti#incoming-73' target=_blank>ბმულს<a/>",
      "პარტიის ხარჯები",
    ],
  },
  {
  ...
  },
  {
    ...
    text: [
      "2019 და 2020 წლებში, ქვემოთ ჩამოთვლილთაგან რომელმა პარტიამ მიიღო ჯამში დანარჩენ ორზე მეტი <span>შემოწირულობა?</span>",
      "კი, ბატონო, ეგრეა! ამ სამ პარტიას შორის ყველაზე მეტი შემოწირულობა 2019-2020 წლებში ლელომ მიიღო - ჯამში 8 495 594 ლარი. ამ ორი წლის განმავლობაში ერთიანმა ნაციონალურმა მოძრაობამ შემოწირულობით - 5 906 315 ლარი, ხოლო პარტიამ “ევროპული საქართველო - მოძრაობა თავისუფლებისთვის” 3 819 383 ლარი მიიღო. ორივე წელს შემოწირულობების რაოდენობით ლიდერობდა ქართული ოცნება, ჯამში 30 917 706 ლარით. მეტი ინფორმაციისთვის მიყევი ამ <a href='https://askgov.ge/en/request/partiebis_shemosavlebis_statisti#incoming-73' target=_blank>ბმულს</a>",
  ...
  },
  {
    ...
    text: [
      "რამდენი ლარით მეტი დახარჯა ქართულმა ოცნებამ 2020-ში, საქართველოს <span>საპარლამენტო არჩევნების წელს</span>, წინა წელთან შედარებით, როდესაც არჩევნები არ ჩატარებულა?",
    ...
    text: [
      "რომელი უფრო მეტია - 2020 წელს ქართული ოცნების შემოსავალი, თუ იმავე წელს, ქართული ოცნების გარდა, <span>5 ყველაზე შემოსავლიანი</span> პარტიის შემოსავლების ჯამი?",
      "სწორად გამოიცანი! ქართული ოცნების შემოსავალი 2020 წელს 29 104 085 ლარს შეადგენდა. მის გარდა 5-მა ყველაზე შემოსავლიანმა პარტიამ ერთად 28 310 788 ლარი მიიღო. ესენია ლელო საქართველოსთვის (7 995 487), ერთიანი ნაციონალური მოძრაობა (7 392 132), ევროპული საქართველო - მოძრაობა თავისუფლებისთვის (5 414 043), საქართველოს პატრიოტთა ალიანსი (4 177 885), გიორგი ვაშაძე - სტრატეგია აღმაშენებელი (3 406 992). მეტი ინფორმაციისთვის მიყევი ამ <a href='https://askgov.ge/en/request/partiebis_shemosavlebis_statisti#incoming-73' target=_blank>ბმულს</a>",
  ...
  },
  {
    ...
    text: [
      "რომელ პარტიას აქვს ყველაზე დიდი “მარგი ქმედების კოეფიციენტი” პარლამენტში, ანუ <span>მანდატების რაოდენობის შეფარდება პარტიის წლიურ ხარჯთან</span> (ბოლო არჩევნების წელს)?",
      "ყოჩაღ შენ და ალეკოს! მისმა პარტიამ 250 843-ლარიანი ხარჯით 2020 წლის არჩევნებში პარლამენტში 2 მანდატი მიიღო. ჩვენ მიერ გამოთვლილი მისი “მარგი ქმედების კოეფიციენტი” უდრის 125 421.5-ს მაშინ, როცა “ლელოსი” - 1 998 871.75-ს, ხოლო “პატრიოტთა ალიანსის” - 1 044 471.25-ს შეადგენს. მეტი ინფორმაციისთვის მიყევი ამ <a href='https://askgov.ge/en/request/partiebis_shemosavlebis_statisti#incoming-73' target=_blank>ბმულს</a>",
