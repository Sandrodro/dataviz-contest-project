const questions = [
  {
    ...
    text: [
      ...
      "სწორად გამოიცანი! 2017 წელს საქართველოს ლეიბორისტული პარტია 215,480 ლარის ოდენობის მივლინების ხარჯებით პირველ ადგილზე გავიდა. მათი ხარჯები ყველა პარტიის ერთად აღებული ხარჯების მეოთხედზე მეტს შეადგენდა. მათ მოსდევთ პარტია “მრეწველობა გადაარჩენს საქართველოს”, რომელმაც 2017 წელს 128,869 დახარჯა. ქართული ოცნება-დემოკრატიული საქართველოს ანალოგიური ხარჯები 31,391 ლარს შეადგენდა. მეტი ინფორმაციისთვის მიყევი ამ <a href='https://askgov.ge/en/request/partiebis_shemosavlebis_statisti#incoming-73' target=_blank>ბმულს</a>",
  ...
  },
  {
    ...
    text: [
      "აღნიშნული პარტიებიდან რომელმა მიიღო ყველაზე დიდი ოდენობით <span>დაფინანსება</span> სახელმწიფო <span>ბიუჯეტიდან</span> 2020 წელს?",
      "სწორად გამოიცანი! 2020 წლის სახელმწიფო ბიუჯეტიდან საქართველოს პატრიოტთა ალიანსმა 1,96 მილიონი ლარი მიიღო. პარტიას სახელმწიფო დაფინანსებით მხოლოდ ქართულმა ოცნებამ გაუსწრო, რომელმაც 4,22 მილიონი ლარი მიიღო ბიუჯეტიდან. ერთიანმა ნაციონალურმა მოძრაობამ  1,84 მილიონი ლარის, ხოლო პარტიამ “ევროპული საქართველო - მოძრაობა თავისუფლებისთვის”  1,52 მილიონი ლარის ოდენობის დაფინანსება მიიღეს. მეტი ინფორმაციისთვის მიყევი ამ <a href='https://askgov.ge/en/request/partiebis_shemosavlebis_statisti#incoming-73' target=_blank>ბმულს</a>",
      "ვერ გამოიცანი! 2020 წლის სახელმწიფო ბიუჯეტიდან საქართველოს პატრიოტთა ალიანსმა 1,96 მილიონი ლარი მიიღო. პარტიას სახელმწიფო დაფინანსებით მხოლოდ ქართულმა ოცნებამ გაუსწრო, რომელმაც 4,22 მილიონი ლარი მიიღო ბიუჯეტიდან. ერთიანმა ნაციონალურმა მოძრაობამ  1,84 მილიონი ლარის, ხოლო პარტიამ “ევროპული საქართველო - მოძრაობა თავისუფლებისთვის”  1,52 მილიონი ლარის ოდენობის დაფინანსება მიიღეს. მეტი ინფორმაციისთვის მიყევი ამ <a href='https://askgov.ge/en/request/partiebis_shemosavlebis_statisti#incoming-73' target=_blank>ბმულს</a>",
      "ბიუჯეტი",
    ],
  },
  {
    ...
    text: [
      "2019 და 2020 წლებში, ქვემოთ ჩამოთვლილთაგან რომელმა პარტიამ მიიღო ჯამში მეტი <span>შემოწირულობა</span>?",
      "სწორად გამოიცანი! ამ სამ პარტიას შორის ყველაზე მეტი შემოწირულობა 2019-2020 წლებში ლელომ მიიღო - ჯამში 8,50 მილიონი ლარი. ამ ორი წლის განმავლობაში ერთიანმა ნაციონალურმა მოძრაობამ შემოწირულობით 5,91 მილიონი ლარი, ხოლო პარტიამ “ევროპული საქართველო - მოძრაობა თავისუფლებისთვის” 3,82 მილიონი ლარი მიიღო. ორივე წელს შემოწირულობების რაოდენობით ლიდერობდა ქართული ოცნება, ჯამში 30,92 მილიონი ლარით.მეტი ინფორმაციისთვის მიყევი ამ <a href='https://askgov.ge/en/request/partiebis_shemosavlebis_statisti#incoming-73' target=_blank>ბმულს</a>",
      "ვერ გამოიცანი! ამ სამ პარტიას შორის ყველაზე მეტი შემოწირულობა 2019-2020 წლებში ლელომ მიიღო - ჯამში 8,50 მილიონი ლარი. ამ ორი წლის განმავლობაში ერთიანმა ნაციონალურმა მოძრაობამ შემოწირულობით 5,91 მილიონი ლარი, ხოლო პარტიამ “ევროპული საქართველო - მოძრაობა თავისუფლებისთვის” 3,82 მილიონი ლარი მიიღო. ორივე წელს შემოწირულობების რაოდენობით ლიდერობდა ქართული ოცნება, ჯამში 30,92 მილიონი ლარით.მეტი ინფორმაციისთვის მიყევი ამ <a href='https://askgov.ge/en/request/partiebis_shemosavlebis_statisti#incoming-73' target=_blank>ბმულს</a>",
      "შემომწირველები",
    ],
  },
];
...
const initialText =
  "რა იცი საქართველოში პოლიტიკური პარტიების დაფინანსების შესახებ? რამდენად ემთხვევა შენი ვარაუდები რეალობას? გამოცადე თავი ჩვენს მოკლე ქვიზში და გაიგე მეტი ამ საკითხზე. <br><br> პასუხის ასარჩევად დააკლიკეთ შესაბამის წრეზე";
